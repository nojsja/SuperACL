...
### **1.09-Ver2** `2021-08-06`
***
- 出国代理 `inchina.acl`
    - [Add] 新增部分港台地区常用网址
    - [Add] 支持雅虎短链接服务
    - [Add] 支持香港 ViuTV 网页版服务
    - [Fix] 解决 HBOMax 提示地区不可用的问题
    - [Improve] 补充部分境外网站 CDN 域名

- 回国代理 `inforeign.acl`
    - [Add] 欢迎即刻回家！
    - [Add] 欢迎小米有品回家！
    - [Add] 欢迎应用汇回家！
    - [Improve] 补充部分字节跳动的多媒体 CDN 域名
...
- 回国代理 `inforeign.acl`
    - [Improve] 基于最新的互联网情况完全重写了该规则文件
    - [Improve] 本次重写优化了大量域名，有针对性的增加了具有境外访问限制的网站 (如部分视频网站)
    - [Add] 欢迎 AcFun 回家！
    - [Add] 欢迎 Bilibili 回家！
    - [Add] 欢迎央视频回家！（经过测试可以看 2020 年东京奥运会节目）
    - [Add] 欢迎中国移动九大基地和咪咕相关网站回家！
    - [Add] 欢迎斗鱼直播回家！
    - [Add] 欢迎虎牙直播回家！
    - [Add] 欢迎粉笔未来回家！
    - [Add] 欢迎猿辅导在线教育回家！
    ...
    - [Add] 欢迎完美世界回家！
    - [Add] 欢迎学信网回家！
    - [Add] 考虑到中国大陆政府网站的特点，酌情增加 gov.cn 下全部域名
    - [Add] 考虑到学校网站以及教育网的特点，酌情增加 edu.cn 下全部域名
    - [Improve] 根据最新情况增删部分字节跳动的 CDN 域名
    - [Improve] 根据最新情况增删部分奇虎 360 的 CDN 和周边服务域名
    - [Delete] 移除部分欢聚时代的域名
    - [Delete] 移除部分久邦数码的域名
    - [Delete] 移除部分无用的统计和跟踪的域名（也可以干扰 Tracker）
